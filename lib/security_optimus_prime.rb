...
def ensure_session_user_agent_stability
		...
		@ensure_session_user_agent_stability_cache_string =  session.session_id.to_s + '_user_agent'
		@session_last_user_agent  = Caching::MemoryCache.instance.read @ensure_session_user_agent_stability_cache_string
		Caching::MemoryCache.instance.write @ensure_session_user_agent_stability_cache_string , request.env["HTTP_USER_AGENT"].delete(" ")    , :expires_in => @cache_expiration
