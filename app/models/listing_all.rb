class ListingAll  < ActiveRecord::Base
...
#
  ...
  def self.search_designs_with_msfte(*args)
        ...
        search_string =   "EXEC sp_executesql N'SELECT  [listing_designs].* FROM [listing_designs] JOIN CONTAINSTABLE([listing_designs], (*), #{search_terms} ) as msfte_ctbl_0 ON [listing_designs].[id] = msfte_ctbl_0.[key] WHERE [listing_designs].[department_id] =  #{search_terms}  ORDER BY msfte_ctbl_0.rank DESC'"
