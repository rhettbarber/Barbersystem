           ...
           if ( $("#side").val()  == "front"   )  {
                                               if ( $("#back_design_verified_correct").val() == 'true' ) {
                                                ...
                                                console.log(" updateAdvancedCombinationBack(  specsheet_type_id,  default_side, number_of_sides, back_left, back_top, back_width   )");
                                                 updateAdvancedCombinationBack( $('#front_advanced_combination_id').val() , $("#item_specsheet_type_id").val() ,  $("#back_design_default_side").val(),  false  , $("#item_number_of_sides").val() ,  $('#back_design_image').css('left') ,  $('#back_design_image').css('top') ,  $('#back_design_image').css('width')   )  ;
...
$(document).on('click','#submit_size_and_position_front', function() {
                ...
                if ( $("#side").val()  == "front"   )  {
                                                ...
                                                console.log( "USE back_advanced_combination_id:" +  $('#back_advanced_combination_id').val() );
                                                console.log( "SET advanced_combination.front_width TO  front_design_image width:" +   $('#front_design_image').css('width') );
                                                updateAdvancedCombinationFront( $('#back_advanced_combination_id').val(),  $("#item_specsheet_type_id").val()  , $("#item_default_side").val() ,  $("#front_design_verified_correct").val()   , $("#item_number_of_sides").val() ,  $('#front_design_image').css('left') ,  $('#front_design_image').css('top') ,  $('#front_design_image').css('width')   )  ;
                } else {
